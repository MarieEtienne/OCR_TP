...
modele_GF <- glm(
  Green.frogs ~  SR+NR+TR+VR+SUR1+SUR2+SUR3+UR+OR+RR+MR+CR, 
  data = dataClean, 
  family = binomial
)
### Modèle Grenouille rousse 
modele_BF <- glm(
  Brown.frogs ~  SR+NR+TR+VR+SUR1+SUR2+SUR3+UR+OR+RR+MR+CR, 
  data = dataClean, 
  family = binomial
)
### Modèle Crapaud commun
modele_CT <- glm(
  Common.toad ~  SR+NR+TR+VR+SUR1+SUR2+SUR3+UR+OR+RR+MR+CR, 
  data = dataClean, 
  family = binomial
)
### Modèle Crapaud sonneur
modele_FBT <- glm(
  Fire.bellied.toad ~  SR+NR+TR+VR+SUR1+SUR2+SUR3+UR+OR+RR+MR+CR, 
  data = dataClean, 
  family = binomial
)
### Modèle Grenouille arboricole
modele_TF <- glm(
  Tree.frog ~  SR+NR+TR+VR+SUR1+SUR2+SUR3+UR+OR+RR+MR+CR, 
  data = dataClean, 
  family = binomial
)
### Modèle Triton commun
modele_CN <- glm(
  Common.newt ~  SR+NR+TR+VR+SUR1+SUR2+SUR3+UR+OR+RR+MR+CR, 
  data = dataClean, 
  family = binomial
)
### Modèle Triton crêté
modele_GCT <- glm(
  Great.crested.newt ~  SR+NR+TR+VR+SUR1+SUR2+SUR3+UR+OR+RR+MR+CR, 
  data = dataClean, 
  family = binomial
)
