...
<style>
  ...
  .esp-fiche img { max-width: 320px; width: 40%; border-radius: 6px; }
...
<div class="esp-menu">
  ...
  <div class="esp-fiche" id="green-frogs">
    <img src="images/green_frog.jpg" alt="Grenouille verte">
    <div>
      ...
      <p><strong>Dans notre étude :</strong> sa présence est significativement
      influencée par l'intensité de la pêche dans les réservoirs (p &lt; 0.01).</p>
    </div>
  </div>
