...
```{r chapitre4-mod1, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r chapitre4-mod2, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r chapitre4-mod3, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r chapitre4-mod4, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r chapitre4-mod5, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r chapitre4-mod6, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r chapitre4-mod7, echo = FALSE, warning = FALSE, message = FALSE}
### Modèle Triton crêté
modele_GCT <- glm(
